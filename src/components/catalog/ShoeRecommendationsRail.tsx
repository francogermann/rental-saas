...
import { SHOE_RECOMMENDATIONS } from '@/lib/shoe-recommendations';

export function ShoeRecommendationsRail() {
  if (SHOE_RECOMMENDATIONS.length === 0) return null;
